        ...
        for(auto j:m)
        {
            for(auto k:m)
            {
                if((i.first+j.first+k.first)%10==3)
                {
                    ...
                    else if((i.first==j.first && i.first==k.first) && (i.second>2))
                    {
                        p=true;break;
                    }
                    else if(i.first==j.first && i.second>1 && i.first!=k.first)
                    {
                        p=true;break;
                    }
                    else if(i.first==k.first && k.second>1 && i.first!=j.first)
                    {
                        p=true;break;
                    }
                    else if(k.first==j.first && k.second>1 && i.first!=k.first)
                    {
                       p=true;break;
                    }
                } 
